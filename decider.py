...
while True:
    ...
    for event in events:
      ...
      if event['eventType'] == 'WorkflowExecutionStarted':
        ...
        decisions.append(swf_helper.schedule_activity_task('A', '1000'))

      elif event['eventType'] == 'ActivityTaskCompleted':
        decisions.append(swf_helper.schedule_activity_task('A', event['activityTaskCompletedEventAttributes']['result']))
